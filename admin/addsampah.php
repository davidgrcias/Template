		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Add Sampah</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30" style = "padding-bottom: 5px!important;">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Add Sampah</h4>
						</div>
					</div>
              ...
              ?>
                  ...
                  <?php endforeach; ?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "area" = "area" maxlength="49" spellcheck="false">
							</div>
						</div>
            <div class="form-group row">
              ...
              $(document).ready(function(){
                  ...
                  var kode = "addsampah";
                    $.ajax({
                      url: 'function.php',
                      type: 'POST',
                      data: { user:user,jenis:jenis,area:area,jumlah:jumlah,kode:kode},
                      success: function(response){
                      if(response == 1){
                        alert('Sampah Added Successfully!');
                      }else if(response == 99){
