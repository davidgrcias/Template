...
<body>
  <?php
    ...
    $selectjeniscut = mysqli_query($connt, "SELECT * FROM jenis WHERE id = $getid");
    if(mysqli_num_rows($selectjeniscut) == 0){
      header("Location: index.php");
    }

    $jenisasli = mysqli_fetch_assoc($selectjeniscut);
  ?>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30" style = "padding-bottom: 5px!important;">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Edit Jenis</h4>
						</div>
					</div>
            ...
            <br>
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "jenis" = "jenis" maxlength="49" spellcheck="false" value = "<?php echo $jenisasli['jenis']; ?>">
							</div>
						</div>
            <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Harga / Kg</label>
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "jumlah" = "jumlah" maxlength="49" spellcheck="false" value = "<?php echo $jenisasli['harga']; ?>">
							</div>
						</div>
            <div class="form-group row">
              ...
              $(document).ready(function(){
                  ...
                  var kode = "editjenis";
                    $.ajax({
                      url: 'function.php',
                      type: 'POST',
                      data: { id:id,jenis:jenis,jumlah:jumlah,kode:kode},
