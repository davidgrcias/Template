  ...
  <!--        </div>-->
    ...
    <form method='POST' action=''>
      ...
      <table>
          <tr>
              <td>
			<p id="ucapan" style="display: inline;">Ucapan:&nbsp</p> 
			</td>
			<td>
			<select id="pilihan1" size = "return this.length();" class='pilihan' style = "width: 100%;" onchange='pilih1()'>
      ...
      <tr>
          <td>
          <p id="doa" style="display: inline;">Doa:&nbsp</p> 
          </td>
          <td>
          <select id="pilihan2" class='pilihan' onchange='pilih2()'>
