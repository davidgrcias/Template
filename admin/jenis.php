        ...
        <!-- Simple Datatable start -->
				<div class="card-box mb-30" id = "tableka">
					<div class="pd-20" style = "display: flex; align-items: center; justify-content: space-between; padding-right: 20px; box-sizing: border-box;">
						<h4 class="text-blue h4">Data Table Jenis</h4>
						<a href="addjenis.php" class = "btn btn-success">Add Jenis</a>
					</div>
					<div class="pb-20">
                  ...
                  <th>Harga / Kg</th>
							...
							<tbody>
                <?php
    							$userfull = query("SELECT * FROM jenis ORDER BY id DESC");
									$i = 1;
    						?>
                  ...
                  <td>
										<?php
										echo number_format($user["harga"], 0, '', '.');
										?>
									</td>
									<td id = "<?php echo $user['id']; ?>">
										<div class="dropdown" id = "<?php echo $user['id']; ?>">
    										...
    										<a class="dropdown-item" href="editjenis.php?id=<?php echo $user['id']; ?>"><i class="dw dw-edit2"></i> Edit</a>
								...
								<script type="text/javascript">
									function deleteaccountadmin(iduser){
											$(document).ready(function(){
													...
													var confirmalert = confirm("Are You Sure You Want To Delete This Jenis?");
													<?php else : ?>
													...
													if (confirmalert == true){
														$.ajax({
															...
															if(response == 1){
																<?php if($admin["notif"] == "y") : ?>
																alert('Jenis Deleted Successfully');
																<?php endif; ?>
